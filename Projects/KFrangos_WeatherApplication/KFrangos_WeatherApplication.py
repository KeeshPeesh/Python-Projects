...
print(input("Press 1 to view all data, 2 to view first five rows, 3 to view statistics, 4 to visualize data, 5 to add new station, 6 to update existing station, 7 to exit: "))
...
#BAR CHART
maroon = '#800000'
plt.bar(df['Location'], wind, color = 'maroon')
